...
from . import views
from .views import PlaylistListCreateView, ViewUserPlaylists, AddPlaylistView, RemovePlaylistView, get_csrf
urlpatterns = [
    ...
    path('playlists/create/', AddPlaylistView.as_view(), name='add-playlist'),
